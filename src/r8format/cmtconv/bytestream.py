...
from    r8format.cmtconv.audio  import samples_to_pulses, pulses_to_samples, \
    filter_clicks, samples_to_pulses_via_edge_detection, \
    pulses_to_samples2
from    r8format.cmtconv.logging  import *
from    r8format.binary.tool  import asl
...
def blocks_from_bin(platform, stream, **args):
